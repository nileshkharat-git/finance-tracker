    ...
    <div className='h-[93vh] flex'>
        <section className='w-1/6 border-r-2 border-gray-100 h-full'>
            <ul className='text-2xl'>
                <li className='px-3 py-4 bg-gray-100 hover:bg-gray-200 cursor-pointer mb-1'>Transactions</li>
                <li className='px-3 py-4 bg-gray-100 hover:bg-gray-200 cursor-pointer mb-1'>Income Sources</li>
